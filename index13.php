...
if(isset($_SESSION['subreddit'])){
    ...
    if(isset($_POST['back'])){
        header("Location: /index11.php?sub=$subreddit");
    }
}else{
    $subreddit = "home";
    if(isset($_POST['back'])){
...
if(isset($_POST['submit'])){
    ...
    $subvar = $_SESSION['subreddit'];
    $postedby = $_SESSION['username'];
    if(!empty($titlevar)){
        $sql ="INSERT INTO `posts` (title, description, postedby, likes, postedin) VALUES ('$titlevar','$descvar','$postedby',0, '$subvar')";
